...
emcc -O2 -s ASM_JS=1 -s INVOKE_RUN=0 \
     -s EXPORTED_FUNCTIONS="['_init_agent_system','_update_agent_system','_get_agent_count','_get_agent_component','_get_agents_pointer','_update_agent_config','_get_trail_size','_get_trail_pointer','_destroy_agent_system']" \
